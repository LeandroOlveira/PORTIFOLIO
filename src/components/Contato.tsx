...
export function Contato() {
  return (
    <section id="contato" aria-labelledby="contato-titulo" data-motion-section="contact" className="bg-mark text-black">
      <div className="shell py-20 md:py-32">
        <div className="grid gap-12 lg:grid-cols-[minmax(0,1.3fr)_minmax(18rem,0.7fr)] lg:items-end lg:gap-20">
          <div>
            <h2 id="contato-titulo" data-motion-title className="title max-w-[17ch] text-[2.4rem] sm:text-[3.5rem] md:text-[4.5rem]">
              Tem uma operação que ainda depende de planilha, retrabalho ou conferência manual?
            </h2>
            <p data-motion-copy className="mt-7 max-w-[58ch] text-base leading-7 text-black/75 sm:text-lg">
